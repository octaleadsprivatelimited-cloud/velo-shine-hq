    ...
    <section className="relative min-h-screen flex items-center overflow-hidden dark-section">
      ...
      <div className="absolute inset-0">
        <img
          ...
          loading="eager"
        />
        <div className="absolute inset-0 bg-[hsl(225,25%,3%/0.65)]" />
        <div className="absolute inset-0 bg-gradient-to-r from-[hsl(225,25%,3%/0.6)] via-[hsl(225,25%,3%/0.3)] to-transparent" />
        <div className="absolute inset-0 bg-gradient-to-t from-[hsl(225,25%,3%/0.85)] via-[hsl(225,25%,3%/0.2)] to-[hsl(225,25%,3%/0.3)]" />
