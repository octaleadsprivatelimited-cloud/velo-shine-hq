    ...
    <section className="relative min-h-screen flex items-center overflow-hidden dark-section">
      ...
      <div className="absolute inset-0">
        <img
          ...
          loading="eager"
        />
        <div className="absolute inset-0 bg-gradient-to-r from-[hsl(225,25%,3%/0.95)] via-[hsl(225,25%,5%/0.75)] to-[hsl(225,25%,5%/0.3)]" />
        <div className="absolute inset-0 bg-gradient-to-t from-[hsl(225,25%,3%)] via-transparent to-[hsl(225,25%,5%/0.4)]" />
      ...
      <div className="container mx-auto px-6 relative z-10 pt-24">
        <div className="max-w-3xl">
          ...
          <motion.h1
            ...
            className="font-display text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-extrabold leading-[0.95] mb-6 text-white"
          >
            Doorstep car wash,{" "}
          ...
          <motion.div
            ...
            className="mt-14 flex flex-wrap items-center gap-6 text-sm text-white/50"
          >
            <div className="flex items-center gap-1.5">
              {[1, 2, 3, 4, 5].map((i) => (
                <Star key={i} className="w-4 h-4 fill-primary text-primary" />
              ))}
              <span className="ml-2 text-white/70 font-semibold">4.9/5</span>
